    ...
    <div class="breadcrumb-outer">
        <div class="auto-container">
            <div class="bread-crumb text-center">
                ...
                <a href="view_post.php" class="current">View order</a>
            </div>
        </div>
    </div>
    ...
    <section class="services-section style-three">
        <div class="auto-container">
            ...
            <div class="row clearfix">
                ...
                <?php
                    $id=$_SESSION['id']; 
                    $query="SELECT * From booked where s_id=$id order by id DESC"; // $id is user id in session
                    // echo $query;
                        ...
                        <?php 
                            if (mysqli_num_rows($result)>0)
                            {
                                while ($rows=mysqli_fetch_assoc($result))
                                {
                                    ...
                                    $pid=$rows['p_id'];
                                    // echo "userid".$id;
                                    $qry1="SELECT * FROM bid where id=$bid";
                                    // echo $qry1;
                                    ...
                                    $qryu="SELECT * FROM user where id='".$rows['user_id']."'";
                        ...
                        ?>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?php echo $rowu['firstname']." ".$rowu['lastname'];?>&nbsp&nbsp<?php echo $row2['description'] ?></td>
