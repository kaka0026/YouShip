...
<div class="page-wrapper">
    ...
    <div class="breadcrumb-outer">
    	<div class="auto-container">
        	<div class="bread-crumb text-center"><a href="index.html">Home</a> <span class="fa fa-angle-right"></span> <a href="#" class="current">Service Single</a></div>
        </div>
    </div>
    ...
    <div class="sidebar-page-container">
        ...
        <div class="auto-container">
            <div class="row clearfix">
                ...
                <?php
                $id=$_GET['id'];
                $qryt="SELECT * FROM vehicle where id=$id";
                $rst=mysqli_query($conn,$qryt);
                $rowt=mysqli_fetch_assoc($rst);
                ?>    
                <form action="bookvehicle.php" method="post">
                <div class="content-side col-lg-8 col-md-8 col-sm-12 col-xs-12 col-lg-offset-2 col-md-offset-2">
                    
                    <!--Single Service-->
                    <section class="single-service">
                            	
                        <!--Main Image-->
                        <figure class="main-image"><img src="<?php echo $rowt['v_img'];?>" alt=""></figure>
                        
                        <h2 class="service-title"><?php echo $rowt['v_name'] ?></h2>
                        <!--Default Text Block-->
                        <div class="text">
                            <p><?php echo $rowt['v_des'];?></p>
                        </div>
                        <input type="hidden" name="id" value="<?php echo $rowt['id'];?>">
                        <input type="hidden" name="sid" value="<?php echo $rowt['sid'];?>">
                        <!-- <input type="hidden" name=""> -->
                        <input class="btn btn-danger" type="submit" name="submit" value="Book for Rent">
