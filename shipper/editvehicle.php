                        ...
                        <div class="get-quote default-form style-two">
                            ...
                            <div class="body table-responsive">
                                ...
                                <?php
                                 ...
                                 ?>
                                <form action="updatevehicledata.php" method="post">
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" name="title" value="<?php echo $row['v_name'] ?>"></td>
                                            <td><input type="text" name="des" value="<?php echo $row['v_des'] ?>"></td>
                                            <td><input type="tel" name="price" value="<?php echo $row['v_price'] ?>"></td>
