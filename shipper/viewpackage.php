    ...
    <div class="breadcrumb-outer">
        <div class="auto-container">
            <div class="bread-crumb text-center">
                ...
                <a href="addpackage.php" class="current">View Package</a></div>
        </div>
    </div>
                    ...
                    <div class="inner-box wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="get-quote default-form style-two">
                            ...
                            <div class="body table-responsive">
                                ...
                                <?php
                                    $add=$_SESSION['id'];
                                    $qry="SELECT * FROM package WHERE added_by='".$add."' && isactive!=2 && utype=1";
                                    // echo "$qry";
                                ...
                                <table class="table table-striped">
                                    ...
                                    <?php 
                                        if (mysqli_num_rows($rs)>0)
                                        {
                                            ...
                                            $qry1="SELECT * FROM shipper where id='".$row['added_by']."'";
                                    ...
                                    ?>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><a href="editpackage.php?id=<?php echo $row['id'] ?>">Edit</a></td>
                                                        <td style="padding-left: 28px;"><a href="blockpackage.php?id=<?php echo $row['id'] ?>">
                                                        <?php 
                                                            if ($ia==1)
                                                            {
                                                        ?>
                                                        ...
                                                        <td><a href="deletepackage.php?id=<?php echo $row['id']; ?>">Delete</a></td>
