        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form action="addpackagedata.php" id="form_validation" method="POST">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="textarea" class="form-control" name="des" required>
                            ...
                            <input type="submit" name="submit" class="btn btn-raised btn-primary waves-effect" type="submit">
                        </form>
                    </div>
                </div>
            </div>
