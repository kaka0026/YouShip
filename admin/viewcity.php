                        ...
                        <table class="table table-striped">
                            ...
                            <?php 
                                if (mysqli_num_rows($rs)>0)
                                {
                                    ...
                                    $qry1="SELECT * FROM state where id='".$row['sid']."'";
                            ...
                            ?>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><a href="blockcity.php?id=<?php echo $row['id'] ?>">
                                                <?php 
                                                    if ($ia==1)
                                                    {
                                                ?>
                         ...
                         <a href="addcity.php"><input type="submit" name="submit" value="Go To Add city" class="btn btn-raised btn-primary waves-effect"></a>
                    </div>
                </div>
            </div>
        </div>
