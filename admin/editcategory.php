                ...
                <div class="card">
                    ...
                    <div class="body table-responsive">
                        ...
                        <?php 
                         ...
                         ?>
                        <form action="updatecategorydata.php" method="post">
                            <table class="table table-striped">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="iname" value="<?php echo $row['itemname']; ?>"></td>
                                    ...
                                    <td><input type="number" name="wt" value="<?php echo $row['weight']; ?>"></td>
