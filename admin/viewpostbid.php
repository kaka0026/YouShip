                    ...
                    ?>
                                <tbody>
                                    <tr>
                                        ...
                                        <td><a href="bookedby.php?id=<?php echo $row['id'];?>">Booked by</a></td>
                                    </tr>
                                </tbody>
                                <?php
                            }
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="body table-responsive">
                        ...
                        <?php 
                            if (mysqli_num_rows($result)>0)
                            {
                                while ($rows=mysqli_fetch_assoc($result))
                                {
                                    ...
                                    $uid=$row2['user_id'];
                                    $qry3="SELECT * from user where id=$uid";
                        ...
                        ?>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?php echo $row3['firstname']?>&nbsp&nbsp<?php echo $row3['lastname'] ?></td>
                    ...
                    <a class="btn btn-raised btn-primary waves-effect " href="viewbid.php">Go to View Posts & Bids</a>             
                </div>
            </div>
        </div>
    </div>
