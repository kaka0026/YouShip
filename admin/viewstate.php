        ...
        <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="body table-responsive">
                        ...
                        <?php 
                             $qry="SELECT * FROM state WHERE isactive!=2";
                            // echo "$qry";
                        ...
                        <table class="table table-striped">
                            ...
                            ?>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><a href="editstate.php?id=<?php echo $row['id'] ?>">Edit</a></td>
                                                <td><a href="blockstate.php?id=<?php echo $row['id'] ?>">
                                                <?php 
                                                    if ($ia==1)
                                                    {
                                                ?>
                         ...
                         <a href="addstate.php"><input type="submit" name="submit" value="Go To Add State" class="btn btn-raised btn-primary waves-effect"></a>
                    </div>
                </div>
            </div>
        </div>
