         ...
         <div class="col-lg-12">
                <div class="card">
                    <div class="body table-responsive">
                        <?php
                            $qry="SELECT * FROM package WHERE isactive!=2";
                            // echo "$qry";
                        ...
                        <table class="table table-striped">
                            ...
                            ?>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><a href="editpackages.php?id=<?php echo $row['id'] ?>">Edit</a></td>
                                                <td><a href="blockpackages.php?id=<?php echo $row['id'] ?>">
                                                <?php 
                                                    if ($ia==1)
                                                    {
                                                ?>
                                                ...
                                                <td><a href="deletepackages.php?id=<?php echo $row['id']; ?>">Delete</a></td>
                         ...
                         <!-- <a href="addpackages.php"><input type="submit" name="submit" value="Go To Add Package" class="btn btn-raised btn-primary waves-effect"></a> -->
                    </div>
                </div>
            </div>
        </div>
