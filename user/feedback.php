...
<div class="page-wrapper">
    ...
    <div class="breadcrumb-outer">
    	<div class="auto-container">
        	<div class="bread-crumb text-center"><a href="index.php">Home</a> <span class="fa fa-angle-right"></span> <a href="#" class="current">Feedback</a></div>
        </div>
    </div>
        	...
        	<div class="row clearfix" style="margin-top: 50px;">
                ...
                <div class="column form-column col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="default-form style-two">
                    	<form method="post" action="feedback_process.php" id="contact-form">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-12 col-sm-12 co-xs-12 form-group">
                                 ...
                                 <div class="col-md-12 col-sm-12 co-xs-12 form-group">
                                    ...
                                    <input type="number" name="phone" value="" placeholder="Phone Number">
                                </div>
                                <div class="col-md-12 col-sm-12 co-xs-12 form-group">
