    ...
    <div class="breadcrumb-outer">
    	<div class="auto-container">
        	<div class="bread-crumb text-center">
                ...
                <a href="viewpost.php" class="current">View Order</a>
            </div>
        </div>
    </div>
    ...
    <section class="services-section style-three">
    	<div class="auto-container">
            ...
            <div class="row clearfix">
                ...
                <?php 
                    $uid=$_SESSION['id'];
                    $qryp="SELECT * FROM booked WHERE user_id=$uid order by id DESC";
                ...
                <table class="table table-striped">
                    ...
                    <?php 
                        if (mysqli_num_rows($rsp)>0)
                        {
                            ...
                            {
                                $qryb="SELECT * FROM req_quote where id='".$rowp['p_id']."'";
                                $rsb=mysqli_query($conn,$qryb);
                                $rowb=mysqli_fetch_assoc($rsb);

                                $qrys="SELECT * FROM shipper where id='".$rowp['s_id']."'";
                    ...
                    ?>
                                <tbody>
                                    <tr>
                                        ...
                                        <td><?php echo $rowb['from_add'] ?></td>
                                        <td><?php echo $rowb['to_add'] ?></td>
