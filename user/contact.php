    	...
    	<div class="auto-container">
        	<div class="row clearfix" style="margin-top: 50px;">
                ...
                <div class="column info-column col-lg-5 col-md-5 col-sm-6 col-xs-12">
                	<h2>Our Address</h2>
                    <div class="info-box">
                    	<div class="desc-text">123,beside vallabhnagar soc. viru complex,3rd floor,wghodiya road,vadodara</div>
                        <ul class="contact-info">
                            <li><div class="icon"><span class="flaticon-location"></span></div><strong>Address</strong>Vadodara </li>
