	...
	<div class="container-fluid">
		<div class="row clearfix">
			<div class="col-lg-5 col-md-12 col-sm-12">
				<div class="card">
				    <h4 class="l-login">User Login</h4>
                    <form action="checklogin.php" class="" id="sign_in"  method="POST">
                        ...
                        <br><a href="reg.php" class="btn btn-raised waves-effect">Register for Customer?</a> &nbsp &nbsp
                        <a href="../shipper/reg.php" class="btn btn-raised waves-effect">Register for Shipper?</a>
                    </form>
				</div>
			</div>
		</div>
